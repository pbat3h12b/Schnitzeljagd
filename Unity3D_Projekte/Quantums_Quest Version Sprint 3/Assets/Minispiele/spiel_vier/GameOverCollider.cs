...
public class GameOverCollider : MonoBehaviour {
	...
	void GameOver(Collider other)
	{
		if (other.gameObject.tag == tagName)
		{
            ...
            if (GameObject.Find("GameController").GetComponent<PlayerInformation>().getGames()[2] == true &&
                GameObject.Find("GameController").GetComponent<PlayerInformation>().getPuzzels()[2] == false)
            {
