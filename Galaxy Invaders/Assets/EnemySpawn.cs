...
public partial class EnemySpawn : MonoBehaviour {
	...
	public void SpawnL3Enemy(int y)
	{
		...
		for (int x=-1; x<0; x++) 
		{
			// Level 3 Gegnerwelle generieren
	...
	public void initlevel()
	{
		...
		for (int y=1; y<5; y++) 
		{
			...
			//Sollten vorher drei andere Wellen aufgetreten sein und die Random
			//Zahl gleich 3 sein wird der Boss gespawnt und der Zähler für die anderen Wellen
